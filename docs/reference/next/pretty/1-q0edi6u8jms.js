(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function h() {
      ...
      if (("suspended" === a.state && a.resume(), !o && !s && l)) {
        s = !0;
        let e = a;
        l.then(
          (t) =>
        ...
        return (
          (0, n.useEffect)(() => {
            i.current &&
              ...
              (o.current = r.default.quickTo(i.current, "x", {
                duration: 0.25,
                ease: "power3.out",
              })),
              (l.current = r.default.quickTo(i.current, "y", {
                duration: 0.25,
                ease: "power3.out",
              })));
          }, []),
    ...
    let s = {
      ...
      u = function (e) {
        ...
        function c(e) {
          ...
          return (0, r.jsx)(c, { ...(s ? { fallback: l } : {}), children: d });
        }
          ...
          s = (0, t.useCallback)(
            (t, s = !1) => {
              ...
              (l.current &&
                ...
                "xy" !== l.current &&
                "xy" !== f &&
                n.default.set(c, { [l.current]: 0 }),
                (l.current = f));
              let m = d.getBoundingClientRect(),
                h = t.getBoundingClientRect(),
                p = h.left + (parseFloat(getComputedStyle(t).paddingLeft) || 0),
                g = c.getBoundingClientRect(),
                y = Number(n.default.getProperty(c, "x")) || 0,
                w = Number(n.default.getProperty(c, "y")) || 0,
                b = g.left - m.left - y,
                v = g.top - m.top - w,
                A =
                  "before" === i
                ...
                S = h.top + h.height / 2 - m.top - v - g.height / 2,
                x =
                  "xy" === f ? { x: P, y: S } : "x" === f ? { x: P } : { y: S };
              if (s) {
                ((o.current = t), n.default.set(c, x));
                return;
              }
              (o.current !== t && (0, r.playTick)(),
                (o.current = t),
                n.default.to(c, {
                  ...x,
                  duration: 0.35,
      ...
      function ({ apply: e, settle: n, guard: r }) {
        let i = 0,
          ...
          c = (t, o) => {
            ...
            let l = Math.min(0.1, o / 1e3);
            e(i * l, a * l);
            let s = Math.exp(-l / 0.34);
        ...
        return {
          push(e, t) {
            ...
            if (((o = n), !(r <= 0))) {
              ...
              ((i += (e / r - i) * 0.35), (a += (t / r - a) * 0.35), l++);
            }
          },
          release() {
            if (
              (o && (performance.now() - o) / 1e3 > 0.14) ||
              l < 3 ||
              90 > Math.hypot(i, a)
            ) {
              (d(), n());
