(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let o = ["touchend", "pointerdown", "mousedown", "keydown"],
      i = null,
      a = null,
      l = null,
      u = !1,
    ...
    function h() {
      ...
      if (("suspended" === i.state && i.resume(), !a && !u && l)) {
        u = !0;
        let e = i;
        l.then(
          (t) =>
    ...
    function m() {
      ...
      if (e) {
        ...
        "running" === e.state &&
          ((s = !0), o.forEach((e) => window.removeEventListener(e, m, !0)));
      }
    }
    {
      let e = () => {
  ...
  (e) => {
    ...
    function i(e, t) {
      let r = Math.max(0, o.indexOf(e));
      return Array.from({ length: t }, (e, t) => o[(r + t) % o.length]);
    }
    let a = "/videos/sample.mp4",
      l = [
        {
          name: "kylablac",
          slug: "kylablac",
    ...
    let u = (0, r.createContext)(l);
    e.s(
      [
        "ProjectsProvider",
        0,
        function ({ projects: e, children: r }) {
          return (0, t.jsx)(u.Provider, { value: e, children: r });
        },
        "useProjects",
        0,
        function () {
  ...
  (e) => {
    ...
    e.s([
      ...
      0,
      function (e, n, o) {
        let i = Math.min(t * e * o * 1.15 * r, 0.72 * n * o);
        return { w: i / r, h: i };
      },
    ]);
  },
    ...
    let u = {
      ...
      s = function (e) {
        ...
        function c(e) {
          ...
          return (0, n.jsx)(c, { ...(u ? { fallback: l } : {}), children: f });
        }
          ...
          u = (0, t.useCallback)(
            (t, u = !1) => {
              let s,
                ...
                f = c?.parentElement;
              if (!t || !c || !f) return;
              let d = "function" == typeof e ? e() : e;
              (l.current &&
                l.current !== d &&
                "xy" !== l.current &&
                "xy" !== d &&
                r.default.set(c, { [l.current]: 0 }),
                (l.current = d));
              let p = f.getBoundingClientRect(),
                h = t.getBoundingClientRect(),
                m = h.left + (parseFloat(getComputedStyle(t).paddingLeft) || 0),
                g = c.getBoundingClientRect(),
                y = Number(r.default.getProperty(c, "x")) || 0,
                b = Number(r.default.getProperty(c, "y")) || 0,
                w = g.left - p.left - y,
                v = g.top - p.top - b,
                P =
                  "before" === o
                    ? ((s = f.getBoundingClientRect()),
                      [...f.children]
                        ...
                        .filter((e) => e.width > 0 && e.right <= m + 0.5)
                        .reduce((e, t) => Math.max(e, t.right), s.left))
                    : 0,
                A =
                  "before" === o
                    ? Math.max(P + 4, m - 8 - g.width) - p.left - w
                    : h.left + h.width / 2 - p.left - w - g.width / 2,
                _ = h.top + h.height / 2 - p.top - v - g.height / 2,
                S =
                  "xy" === d ? { x: A, y: _ } : "x" === d ? { x: A } : { y: _ };
              if (u) {
                ((a.current = t), r.default.set(c, S));
                return;
              }
              (a.current !== t && (0, n.playTick)(),
                (a.current = t),
                r.default.to(c, {
                  ...S,
                  duration: 0.35,
  ...
  (e) => {
    ...
    e.s([
      ...
      function (e = window.location) {
        ...
        return "stills" === n || "motion" === n ? n : null;
      },
      ...
      function (e) {
        let t = e.filter((e) => "stills" === e.type).length,
          r = e.filter((e) => "motion" === e.type).length;
        return [
          { label: `stills(${t})`, filter: "stills" },
          { label: `motion(${r})`, filter: "motion" },
        ];
      },
    ]);
  },
  ...
  (e) => {
    ...
    e.s([
      ...
      function (e, t, n) {
        ...
        let o = e ? [...e.querySelectorAll(".roll-inner")] : [];
        if (0 === o.length) return Promise.resolve();
        (e.classList.add("is-hand-animating"),
          window.clearTimeout(Number(e.dataset.rollTimer)));
        let i = 450 + (o.length - 1) * 40;
        return (
          "out" === t
            ? o.forEach((e, t) => {
                ((e.style.transition = ""),
    ...
    e.s([
      ...
      function ({ ref: e }) {
        ...
        return (
          (0, r.useEffect)(() => {
            o.current &&
              (n.default.set(o.current, {
                xPercent: -50,
                yPercent: -50,
                x: window.innerWidth / 2,
                y: window.innerHeight / 2,
              }),
              (a.current = n.default.quickTo(o.current, "x", {
                duration: 0.25,
                ease: "power3.out",
              })),
              (l.current = n.default.quickTo(o.current, "y", {
                duration: 0.25,
                ease: "power3.out",
              })));
          }, []),
          (0, r.useImperativeHandle)(e, () => ({
            move: (e, t) => {
              (a.current?.(e), l.current?.(t));
            },
            set: (e) => {
              let t = o.current;
              t &&
                (e.visible !== u.current.visible &&
                  n.default.to(t, {
                    opacity: +!!e.visible,
                    duration: 0.25,
                    ease: "power2.out",
    ...
    e.s([
      ...
      function ({ clients: e }) {
        let i = (0, r.useRef)(null),
          a = (e?.map((e) => e.slug).filter(Boolean) ?? []).filter((e) =>
            o.includes(e),
          ),
          l = a.length > 0 ? a : o,
          u = l.join("|");
  ...
  (e, t, r) => {
    ...
    function y(t) {
      ...
      let o,
        i,
        y,
        [w, v] = (0, l.useOptimistic)(h.IDLE_LINK_STATUS),
        P = (0, l.useRef)(null),
        {
          href: A,
          as: _,
      ...
      let U = l.default.useContext(s.AppRouterContext),
        ...
        F =
          !1 !== E
            ...
            : g.FetchStrategy.PPR,
        G = "string" == typeof (r = _ || A) ? r : (0, u.formatUrl)(r);
      if (I) {
      ...
      let W = I ? i && "object" == typeof i && i.ref : k,
        V = l.default.useCallback(
          (e) => (
            null !== U &&
              (P.current = (0, h.mountLinkInstance)(e, G, U, F, D, v)),
            () => {
              (P.current &&
        ...
        z = {
          ...
          onMouseEnter(e) {
            (I || "function" != typeof R || R(e),
              ...
              U && D && (0, h.onNavigationIntent)(e.currentTarget, !0 === B));
          },
      ...
      return (
        (0, f.isAbsoluteUrl)(G)
          ? (z.href = G)
          : (I && !j && ("a" !== i.type || "href" in i.props)) ||
            (z.href = (0, d.addBasePath)(G)),
        (y = I
          ? l.default.cloneElement(i, z)
          : (0, a.jsx)("a", { ...$, ...z, children: o })),
        (0, a.jsx)(b.Provider, { value: w, children: y })
      );
    }
    e.r(84508);
